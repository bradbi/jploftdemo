 ...
 *
 * Figma Screen: Upload Photo Of Id
 * Node ID: 51:50
 */

interface Props {}

const UploadPhotoOfIdScreen: React.FC<Props> = () => {
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.placeholder}>
          <Text style={styles.title}>Upload Photo Of Id</Text>
...
export default UploadPhotoOfIdScreen;
