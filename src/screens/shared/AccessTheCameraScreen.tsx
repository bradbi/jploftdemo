 ...
 *
 * Figma Screen: Access The Camera
 * Node ID: 57:56
 */

interface Props {}

const AccessTheCameraScreen: React.FC<Props> = () => {
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.placeholder}>
          <Text style={styles.title}>Access The Camera</Text>
...
export default AccessTheCameraScreen;
