 ...
 *
 * Figma Screen: Onboarding Detailer
 * Node ID: 66:45
 */

interface Props {}

const OnboardingDetailerScreen: React.FC<Props> = () => {
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.placeholder}>
          <Text style={styles.title}>Onboarding Detailer</Text>
...
export default OnboardingDetailerScreen;
