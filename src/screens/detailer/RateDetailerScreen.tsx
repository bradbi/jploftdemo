 ...
 *
 * Figma Screen: Rate Detailer
 * Node ID: 120:99
 */

interface Props {}

const RateDetailerScreen: React.FC<Props> = () => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.content}>
        ...
        {/* Figma Node ID: 120:99 */}

        <View style={styles.placeholder}>
          <Text style={styles.title}>Rate Detailer</Text>
...
export default RateDetailerScreen;
