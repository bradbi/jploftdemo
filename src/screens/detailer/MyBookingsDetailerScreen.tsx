 ...
 *
 * Figma Screen: My Bookings Detailer
 * Node ID: 93:72
 */

interface Props {}

const MyBookingsDetailerScreen: React.FC<Props> = () => {
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.placeholder}>
          <Text style={styles.title}>My Bookings Detailer</Text>
...
export default MyBookingsDetailerScreen;
