 ...
 *
 * Figma Screen: Choose Role Detailer
 * Node ID: 63:42
 */

interface Props {}

const ChooseRoleDetailerScreen: React.FC<Props> = () => {
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.placeholder}>
          <Text style={styles.title}>Choose Role Detailer</Text>
...
export default ChooseRoleDetailerScreen;
